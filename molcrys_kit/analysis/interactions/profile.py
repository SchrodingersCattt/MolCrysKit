...
PROFILE_KIND_ALIASES: dict[str, str] = {}
...
def interaction_profile(
    ...
    *,
    ...
    """Return count/max/mean/sum scoring profile for interaction detectors.

    Detects hydrogen bonds, halogen bonds, and pi-stacking (parallel +
    T-shape).  C-H···π is subsumed by T-shape pi-stacking; H···H close
    contacts are excluded as they are packing artifacts without directional
