...
from ..utils.geometry import cart_to_frac, frac_to_cart, get_rotation_matrix
...
class TopologicalSlabGenerator:
    ...
    def build(
        ...
        final_lattice[2] = (slab_thickness + vacuum) * normal_vector  # Replace the c vector with the orthogonal one
