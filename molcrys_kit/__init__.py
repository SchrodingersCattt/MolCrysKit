...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "NamingParseError": (".chemistry", "NamingParseError"),
    ...
    "from_iupac_name": (".chemistry", "from_iupac_name"),
    "iupac_to_smiles": (".chemistry", "iupac_to_smiles"),
    "name_crystal": (".chemistry", "name_crystal"),
    "name_entity": (".chemistry", "name_entity"),
    "smiles_to_iupac": (".chemistry", "smiles_to_iupac"),
