...
| You are… | Start here |
|---|---|
| **Using the library** | [API & Recipes](docs/api.md) · [Tutorials](docs/tutorials.md) |
| **AI agent (using the library)** | [API & Recipes](docs/api.md) — read "At a Glance" then "Recipes" |
| **AI agent (modifying code)** | [AGENTS.md](AGENTS.md) · [Architecture](docs/architecture.md) |
| **Docker / cloud** | [Docker Guide](docs/docker.md) |
| **CLI (coming soon)** | [CLI Reference](docs/cli.md) |
