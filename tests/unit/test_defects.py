...
def test_vacancy_generation_with_seed(simple_crystal):
    ...
    removal_indices = vacancy_gen.find_removable_cluster_indices(target_spec, seed_index)
...
def test_invalid_seed_index(simple_crystal):
    ...
    with pytest.raises(ValueError):
        vacancy_gen.generate_vacancy(target_spec=target_spec, seed_index=invalid_seed_index)