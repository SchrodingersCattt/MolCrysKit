...
def isomer_crystal():
    ...
    butane = Atoms('CCCC', positions=[[0.0, 0.0, 0.0], [1.5, 0.0, 0.0], [3.0, 0.0, 0.0], [4.5, 0.0, 0.0]])
    ...
    isobutane = Atoms('CCCC', positions=[[0.0, 2.0, 0.0], [3.0, 2.0, 0.0], [1.5, 2.0, 0.0], [1.5, 3.5, 0.0]])
    
    molecules = [
        CrystalMolecule(butane),      # Should be identified as one species due to linear connectivity
        CrystalMolecule(isobutane)    # Should be identified as a different species due to branched connectivity
    ]
