#!/usr/bin/env python3
"""
Test script to verify metal/non-metal bonding threshold functionality.
"""

import numpy as np
from molcrys.structures.atom import Atom
from molcrys.structures.molecule import Molecule
from molcrys.constants import is_metal_element
